	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [REBATENO], [SEQNO], [FROMAMOUNT], [TOVALUE], [REBATEPERC], [REBATEVALUE], [VALUETYPE], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [Account] FROM [CRDRebateScale]  WHERE [RECID]=:recid  ";
