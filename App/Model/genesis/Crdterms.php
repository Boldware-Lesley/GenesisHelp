	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TERMCODE], [CALCSTART], [TERMFROMVALUE], [TERMFROMTYPE], [TERMFROM], [TERMDISCOUNT], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [SAPCODE] FROM [CRDTerms]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_TERMCODE($termcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TERMCODE], [CALCSTART], [TERMFROMVALUE], [TERMFROMTYPE], [TERMFROM], [TERMDISCOUNT], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [SAPCODE] FROM [CRDTerms]  WHERE [TERMCODE]=:termcode  ";
			$stmt = $conn->getStatement($query);
