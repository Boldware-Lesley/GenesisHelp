	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [BatchNo], [Account], [Name], [Debit], [Credit], [VAT], [Reference], [Details], [GLAccNo], [SourceBranch], [Status] FROM [DEBJnlBatchDetl]  WHERE [RecID]=:recid  ";
