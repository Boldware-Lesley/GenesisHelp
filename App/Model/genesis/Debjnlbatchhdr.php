	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [BatchNo], [BatchDate], [Description], [TotalDebit], [TotalCredit], [CreateDate], [CreateTime], [CreateUser], [CreateMacID], [PostDate], [PostTime], [PostUser], [PostMacID] FROM [DEBJnlBatchHdr]  WHERE [RecID]=:recid  ";
