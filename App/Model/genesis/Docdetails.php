...
class Docdetails {
    ...
    public $splitqty =0;
	public $splitunits=0;
	public $splitpriceexcl=0 ;
	public $splitpriceincl =0;
	public $loyaltypnts =0;
	public $pickqty =0;
	public $pickbox =0;
	public $freelineind ="";
	...
	public $linediscount =0;
	public $linevat =0;
	public $linetotal =0;
	public $linetotalexcl=0 ;
	public $linetotalincl =0;
	public $linkqty =0;
	public $vatrate =0;
	public $costexcl =0;
	public $costincl =0;
	public $totalcostexcl=0 ;
	public $totalcostincl =0;
	public $profit =0;
	public $units =0;
	public $weight =0;
	public $ap ="";
    public $serialcount =0;
	public $oldprice =0;
	public $sqmbox ="";
    public $noofbox ="";
    public $cases =0;
	public $palettes=0 ;
	public $dispatchqty=0 ;
	public $dispatchreturns ="";
    public $dispatchbalance ="";
    public $baseline ="";
    public $rebamnt =0;
	public $qtyinvoice=0 ;
	public $qtyreturned=0 ;
	public $qtybalance =0;
	public $basedocamnt ="";
    public $basedocbal ="";
    public $basepayamnt ="";
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Description1], [Description2], [DiscountType], [VATIndicator], [Wh], [SalesRep], [Dept], [SubDept], [Text1], [Text2], [PriceCode], [Promotion], [PromotionType], [PromotionCode], [AuthoriseCode], [PackSize], [SerialTrack], [TileSize], [TileGrade], [VATCode], [StockType], [Status], [BaseType], [BaseRef], [Variant], [SourceBranch], [BasePrice], [BasePriceCode], [PriceChange], [SaleGroup], [ManQty], [ManPrice], [DispatchBranch], [DispatchBox], [SplitCode], [SplitQty], [SplitUnits], [SplitPriceExcl], [SplitPriceIncl], [LoyaltyPnts], [PickQty], [PickBox], [FreeLineInd], [CreditNoteReason], [BarCode], [EODDate], [Supervisor], [SapDocNo], [DrCr], [Supervisor2], [LineNo], [Quantity], [Price], [PriceExcl], [PriceIncl], [DiscountValue], [LineDiscount], [LineVAT], [LineTotal], [LineTotalExcl], [LineTotalIncl], [LinkQty], [VATRate], [CostExcl], [CostIncl], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [Weight], [AP], [SerialCount], [OldPrice], [SqmBox], [NoOfBox], [Cases], [Palettes], [DispatchQty], [DispatchReturns], [DispatchBalance], [BaseLine], [RebAmnt], [QtyInvoice], [QtyReturned], [QtyBalance], [BaseDocAmnt], [BaseDocBal], [BasePayamnt], [BasePayDisc], [Dimensions], [TotalDiscount], [FinalTotal], [ManProfit], [ManDiscount], [ManVAT], [ManTotal], [Onhand], [AvgWeekSale], [AvgCostExcl], [AvgCostIncl], [RebAvgAmnt] FROM [DOCDetails]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Description1], [Description2], [DiscountType], [VATIndicator], [Wh], [SalesRep], [Dept], [SubDept], [Text1], [Text2], [PriceCode], [Promotion], [PromotionType], [PromotionCode], [AuthoriseCode], [PackSize], [SerialTrack], [TileSize], [TileGrade], [VATCode], [StockType], [Status], [BaseType], [BaseRef], [Variant], [SourceBranch], [BasePrice], [BasePriceCode], [PriceChange], [SaleGroup], [ManQty], [ManPrice], [DispatchBranch], [DispatchBox], [SplitCode], [SplitQty], [SplitUnits], [SplitPriceExcl], [SplitPriceIncl], [LoyaltyPnts], [PickQty], [PickBox], [FreeLineInd], [CreditNoteReason], [BarCode], [EODDate], [Supervisor], [SapDocNo], [DrCr], [Supervisor2], [LineNo], [Quantity], [Price], [PriceExcl], [PriceIncl], [DiscountValue], [LineDiscount], [LineVAT], [LineTotal], [LineTotalExcl], [LineTotalIncl], [LinkQty], [VATRate], [CostExcl], [CostIncl], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [Weight], [AP], [SerialCount], [OldPrice], [SqmBox], [NoOfBox], [Cases], [Palettes], [DispatchQty], [DispatchReturns], [DispatchBalance], [BaseLine], [RebAmnt], [QtyInvoice], [QtyReturned], [QtyBalance], [BaseDocAmnt], [BaseDocBal], [BasePayamnt], [BasePayDisc], [Dimensions], [TotalDiscount], [FinalTotal], [ManProfit], [ManDiscount], [ManVAT], [ManTotal], [Onhand], [AvgWeekSale], [AvgCostExcl], [AvgCostIncl], [RebAvgAmnt] FROM [DOCDetails]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
