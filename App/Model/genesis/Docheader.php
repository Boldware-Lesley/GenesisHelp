...
class Docheader {
	...
	public $d180 =0;
	public $dover =0;
	public $totallinedisc =0;
	public $totalrebamnt =0;
	public $weight =0;
	public $cases =0;
	public $pallets=0;
	public $dimensions =0;
	public $detaillines =0;
	...
	public $manvat =0;
	public $mantotal =0;
	public $docdiscount =0;
	public $totalvat =0;
	public $totalexcl =0;
    public $points_acquired=0;
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [TranTime], [Name], [Address1], [Address2], [Address3], [Address4], [Contact], [Telephone], [Fax], [VATNumber], [SalesRep], [Reference], [BaseType], [BaseRef], [VATIndicator], [WH], [PaymentDate], [Details], [Notes], [DeliveryMethod], [DeliveryDate], [Dispatch], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [CashUpdate], [CashUptime], [UField1], [UField2], [UField3], [UField4], [UnAllocated], [ReturnInvoice], [RefInv], [OrderBy], [PurchaseOrder], [Status], [SBO_TimeStamp], [DeliveryAddress1], [DeliveryAddress2], [DeliveryAddress3], [DeliveryAddress4], [EODDate], [Supervisor], [SAPDocNo], [ServerStatus], [ServerDate], [ServerTime], [Version], [ScanUser], [ScanDate], [ScanTime], [SourceBranch], [InUse], [CellPhone], [DocDiscVAT], [DropSafe], [DispatchBranch], [OnlineAccount], [Wallets], [LoyaltyPnts], [LicenseNo], [LicenseExpDate], [DrCr], [TotalIncl], [TotalTaxable], [TotalExempt], [TotalCostExcl], [TotalCostIncl], [Profit], [AP], [Cash], [Cheques], [CreditCards], [Vouchers], [Transfers], [TenderAmount1], [TenderAmount2], [TenderAmount3], [TenderAmount4], [Tendered], [TenderChange], [RoundingDown], [RoundingUp], [CashUpnumber], [Deposit], [Paid], [Balance], [TermDays], [PrintCount], [DCurr], [D030], [D060], [D090], [D120], [D150], [D180], [DOver], [TotalLineDisc], [TotalRebAmnt], [Weight], [Cases], [Pallets], [Dimensions], [DetailLines], [TotalDiscount], [FinalTotal], [ManProfit], [ManDiscount], [ManVAT], [ManTotal], [DocDiscount], [TotalVAT], [TotalExcl] FROM [DOCHeader]  WHERE [RecID]=:recid  ";
