	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CATEGORY2], [DESCRIPTION], [CATEGORY1], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [ExtDate], [ExtTime], [ItemCount], [TotCostExcl], [TotSalesExcl], [TotRebates] FROM [GSMCategory2]  WHERE [RECID]=:recid  ";
