	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CATEGORY3], [DESCRIPTION], [CATEGORY2], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [ExtDate], [ExtTime], [ItemCount], [TotCostExcl], [TotSalesExcl], [TotRebates] FROM [GSMCategory3]  WHERE [RECID]=:recid  ";
