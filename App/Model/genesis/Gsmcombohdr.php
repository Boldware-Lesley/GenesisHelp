	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [ComboNo], [Description], [FromDate], [ToDate], [SellExcl], [SellIncl], [CostExcl], [CostIncl], [DefSellExcl], [DefSellIncl], [MaxCust], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMComboHdr]  WHERE [RecID]=:recid  ";
