	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CPRNo], [VIPCatCode], [Description], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMCPRVIPCats]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPCatCode($vipcatcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CPRNo], [VIPCatCode], [Description], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMCPRVIPCats]  WHERE [VIPCatCode]=:vipcatcode  ";
			$stmt = $conn->getStatement($query);
