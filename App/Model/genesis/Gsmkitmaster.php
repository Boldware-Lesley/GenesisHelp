	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [KitStockCode], [KitLinkCode], [KitQty], [KitLinkQty], [KitUnits], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [KitFixedCost], [KitWaste], [KitProdItem] FROM [GSMKitMaster]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [KitStockCode], [KitLinkCode], [KitQty], [KitLinkQty], [KitUnits], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [KitFixedCost], [KitWaste], [KitProdItem] FROM [GSMKitMaster]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
