	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [SplitCode], [Description1], [Units], [PriceExcl], [PriceIncl], [PromFDate], [PromTDate], [PromFTime], [PromTTime], [PromMaxQty], [PromQtySold], [PromMCust], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [LinkCode] FROM [GSMMstSplitCodes]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [SplitCode], [Description1], [Units], [PriceExcl], [PriceIncl], [PromFDate], [PromTDate], [PromFTime], [PromTTime], [PromMaxQty], [PromQtySold], [PromMCust], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [LinkCode] FROM [GSMMstSplitCodes]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
