	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [PRCHGNO], [DESCRIPTION], [ACCOUNT], [NAME], [DATECOSTUPD], [DATESELLUPD], [COSTSTATUS], [SELLSTATUS], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [DEBCOMPANY], [DEBBRANCH], [AuthStatus] FROM [GSMPrChgHdr]  WHERE [RECID]=:recid  ";
