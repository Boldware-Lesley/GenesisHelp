	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [DEPTCODE], [SUBDEPT], [DESCRIPTION], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [GSMSubDept]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_DEPTCODE($deptcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [DEPTCODE], [SUBDEPT], [DESCRIPTION], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [GSMSubDept]  WHERE [DEPTCODE]=:deptcode  ";
			$stmt = $conn->getStatement($query);
