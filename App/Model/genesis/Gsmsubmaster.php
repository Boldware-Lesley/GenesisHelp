	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [LinkCode], [SubCode], [Description1], [Description2], [SuppCode], [BarCode], [Variant], [Units], [Singles], [PackCase], [CasePall], [PackSize], [Binlocation], [Weight], [ItemLength], [ItemBreadth], [ItemHeight], [PurchaseItem], [SaleItem], [InventoryItem], [PrintLabel], [MiscGP], [Status], [LastCostExcl], [LastCostIncl], [AvgCostExcl], [AvgCostIncl], [BuyCostExcl], [BuyCostIncl], [BaseCostExcl], [BaseCostIncl], [RebateAvgExcl], [RebateLastExcl], [CreateDate], [CreateTime], [CreateUser], [CreateMacID], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Version] FROM [GSMSubMaster]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [StockCode], [LinkCode], [SubCode], [Description1], [Description2], [SuppCode], [BarCode], [Variant], [Units], [Singles], [PackCase], [CasePall], [PackSize], [Binlocation], [Weight], [ItemLength], [ItemBreadth], [ItemHeight], [PurchaseItem], [SaleItem], [InventoryItem], [PrintLabel], [MiscGP], [Status], [LastCostExcl], [LastCostIncl], [AvgCostExcl], [AvgCostIncl], [BuyCostExcl], [BuyCostIncl], [BaseCostExcl], [BaseCostIncl], [RebateAvgExcl], [RebateLastExcl], [CreateDate], [CreateTime], [CreateUser], [CreateMacID], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Version] FROM [GSMSubMaster]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
