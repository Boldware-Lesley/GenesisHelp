	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CardType], [Description], [VIPContCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPCardTypes]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPContCode($vipcontcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CardType], [Description], [VIPContCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPCardTypes]  WHERE [VIPContCode]=:vipcontcode  ";
			$stmt = $conn->getStatement($query);
