	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [VIPGradeCode], [Description], [FromValue], [ToValue], [StdPoints], [HousePoints], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPGrades]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPGradeCode($vipgradecode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [VIPGradeCode], [Description], [FromValue], [ToValue], [StdPoints], [HousePoints], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPGrades]  WHERE [VIPGradeCode]=:vipgradecode  ";
			$stmt = $conn->getStatement($query);
