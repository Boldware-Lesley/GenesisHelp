	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [SourceBranch], [VIPCardNo], [Name], [Title], [Address1], [Address2], [Address3], [Address4], [PostCode], [CellNo], [Telephone], [EMail], [DateJoined], [BirthDate], [IDNo], [Gender], [Status], [VIPPackCode], [VIPGradeCode], [VendorCardNo], [DEBAccount], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPMembers]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_PostCode($postcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [SourceBranch], [VIPCardNo], [Name], [Title], [Address1], [Address2], [Address3], [Address4], [PostCode], [CellNo], [Telephone], [EMail], [DateJoined], [BirthDate], [IDNo], [Gender], [Status], [VIPPackCode], [VIPGradeCode], [VendorCardNo], [DEBAccount], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPMembers]  WHERE [PostCode]=:postcode  ";
			$stmt = $conn->getStatement($query);
