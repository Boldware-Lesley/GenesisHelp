	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [VIPCatCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPMemCats]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPCatCode($vipcatcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [VIPCatCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPMemCats]  WHERE [VIPCatCode]=:vipcatcode  ";
			$stmt = $conn->getStatement($query);
