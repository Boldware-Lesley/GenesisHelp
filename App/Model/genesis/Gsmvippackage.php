	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [VIPPackCode], [Description], [CardType], [CardCharge], [RewardMthd], [VIPContCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPPackage]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPPackCode($vippackcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [VIPPackCode], [Description], [CardType], [CardCharge], [RewardMthd], [VIPContCode], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPPackage]  WHERE [VIPPackCode]=:vippackcode  ";
			$stmt = $conn->getStatement($query);
