	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [VIPRewardCode], [StockCode], [LinkCode], [Description1], [FromQty], [ToQty], [Points], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPRewardDet]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPRewardCode($viprewardcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [VIPRewardCode], [StockCode], [LinkCode], [Description1], [FromQty], [ToQty], [Points], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [GSMVIPRewardDet]  WHERE [VIPRewardCode]=:viprewardcode  ";
			$stmt = $conn->getStatement($query);
