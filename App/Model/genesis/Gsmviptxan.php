	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [TranDate], [TxTp], [Details], [DocNo], [Reference], [DrCr], [Points], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [SourceBranch] FROM [GSMVIPTxan]  WHERE [RecID]=:recid  ";
