...
Class is using the following global variables:
	...
	"public float BackOrdQty" of type [float]
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [TxTp], [DocNo], [TranDate], [Account], [Name], [OrdQty], [DelvQty], [BackOrdQty], [LastCostExcl], [LastCostIncl], [AvgCostExcl], [AvgCostIncl], [PriceExcl], [PriceIncl], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [ORDBackOrderDet]  WHERE [RecID]=:recid  ";
			...
			while($records  = $stmt->fetch( PDO::FETCH_ASSOC )) {
				...
				$instance->backordqty = $records["BackOrdQty"];
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [TxTp], [DocNo], [TranDate], [Account], [Name], [OrdQty], [DelvQty], [BackOrdQty], [LastCostExcl], [LastCostIncl], [AvgCostExcl], [AvgCostIncl], [PriceExcl], [PriceIncl], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [ORDBackOrderDet]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
