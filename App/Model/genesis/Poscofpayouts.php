	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [COFTILLNO], [DOCNO], [TXTP], [PAYOUTCODE], [PAYDATE], [PAYTIME], [PAYEE], [DETAILS], [REFERENCE], [SUPERVISOR], [AMOUNT], [VATAMOUNT], [GLACNO], [SAPGLACNO], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [POSCOFPayouts]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_PAYOUTCODE($payoutcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [COFTILLNO], [DOCNO], [TXTP], [PAYOUTCODE], [PAYDATE], [PAYTIME], [PAYEE], [DETAILS], [REFERENCE], [SUPERVISOR], [AMOUNT], [VATAMOUNT], [GLACNO], [SAPGLACNO], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [POSCOFPayouts]  WHERE [PAYOUTCODE]=:payoutcode  ";
			$stmt = $conn->getStatement($query);
