	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TillNo], [TranDate], [C001], [C002], [C005], [C010], [C020], [C050], [C100], [C200], [C500], [C1000], [Notes], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [POSCoinageCtrl]  WHERE [RecID]=:recid  ";
