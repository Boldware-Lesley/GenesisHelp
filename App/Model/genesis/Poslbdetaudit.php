	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [LineNo], [StockCode], [LinkCode], [Description1], [Description2], [Quantity], [Price], [PriceExcl], [PriceIncl], [DiscountType], [DiscountValue], [LineDiscount], [LineVAT], [LineTotal], [LineTotalExcl], [LineTotalIncl], [LinkQty], [VATCode], [VATRate], [VATIndicator], [CostExcl], [CostIncl], [AvgCostExcl], [AvgCostIncl], [TotalCostExcl], [TotalCostIncl], [Profit], [OldPrice], [PriceChange], [Supervisor], [Supervisor2], [WH], [SalesRep], [Dept], [SubDept], [StockType], [SaleGroup], [Units], [AP], [Weight], [Text1], [Text2], [PriceCode], [Promotion], [PromotionType], [PromotionCode], [AuthoriseCode], [PackSize], [SerialTrack], [SerialCount], [SqmBox], [TileSize], [TileGrade], [NoOfBox], [Cases], [Palettes], [DispatchQty], [DispatchReturns], [DispatchBalance], [Status], [RebAmnt], [FreeLineInd], [CreditNoteReason], [BarCode], [EODDate], [SAPDocNo], [Dimensions], [QtyInvoice], [QtyReturned], [QtyBalance], [BaseType], [BaseRef], [BaseLine], [BaseDocAmnt], [BaseDocBal], [BasePayAmnt], [BasePayDisc], [BasePrice], [BasePriceCode], [DrCr], [TotalDiscount], [FinalTotal], [ManQty], [ManPrice], [ManProfit], [ManDiscount], [ManVAT], [ManTotal], [Onhand], [AvgWeekSale], [RebAvgAmnt], [Variant], [SourceBranch], [DispatchBranch], [DispatchBox], [SplitCode], [SplitQty], [SplitUnits], [SplitPriceExcl], [SplitPriceIncl], [LoyaltyPnts], [PickQty], [PickBox] FROM [POSLBDetAudit]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [LineNo], [StockCode], [LinkCode], [Description1], [Description2], [Quantity], [Price], [PriceExcl], [PriceIncl], [DiscountType], [DiscountValue], [LineDiscount], [LineVAT], [LineTotal], [LineTotalExcl], [LineTotalIncl], [LinkQty], [VATCode], [VATRate], [VATIndicator], [CostExcl], [CostIncl], [AvgCostExcl], [AvgCostIncl], [TotalCostExcl], [TotalCostIncl], [Profit], [OldPrice], [PriceChange], [Supervisor], [Supervisor2], [WH], [SalesRep], [Dept], [SubDept], [StockType], [SaleGroup], [Units], [AP], [Weight], [Text1], [Text2], [PriceCode], [Promotion], [PromotionType], [PromotionCode], [AuthoriseCode], [PackSize], [SerialTrack], [SerialCount], [SqmBox], [TileSize], [TileGrade], [NoOfBox], [Cases], [Palettes], [DispatchQty], [DispatchReturns], [DispatchBalance], [Status], [RebAmnt], [FreeLineInd], [CreditNoteReason], [BarCode], [EODDate], [SAPDocNo], [Dimensions], [QtyInvoice], [QtyReturned], [QtyBalance], [BaseType], [BaseRef], [BaseLine], [BaseDocAmnt], [BaseDocBal], [BasePayAmnt], [BasePayDisc], [BasePrice], [BasePriceCode], [DrCr], [TotalDiscount], [FinalTotal], [ManQty], [ManPrice], [ManProfit], [ManDiscount], [ManVAT], [ManTotal], [Onhand], [AvgWeekSale], [RebAvgAmnt], [Variant], [SourceBranch], [DispatchBranch], [DispatchBox], [SplitCode], [SplitQty], [SplitUnits], [SplitPriceExcl], [SplitPriceIncl], [LoyaltyPnts], [PickQty], [PickBox] FROM [POSLBDetAudit]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
