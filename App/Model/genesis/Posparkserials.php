	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [LineNo], [StockCode], [LinkCode], [SerialNo], [LinkedSerialNo] FROM [POSParkSerials]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [TillNo], [DocNo], [Account], [TranDate], [LineNo], [StockCode], [LinkCode], [SerialNo], [LinkedSerialNo] FROM [POSParkSerials]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
