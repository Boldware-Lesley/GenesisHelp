	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPContCode], [Description], [DeviceName], [ContractRate], [ContractTerm], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [POSVIPContracts]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_VIPContCode($vipcontcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPContCode], [Description], [DeviceName], [ContractRate], [ContractTerm], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [POSVIPContracts]  WHERE [VIPContCode]=:vipcontcode  ";
			$stmt = $conn->getStatement($query);
