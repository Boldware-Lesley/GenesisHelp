	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [VIPNo], [OldCardNo], [NewCardNo], [SourceBranch], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [POSVIPMemCards]  WHERE [RecID]=:recid  ";
