	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [DealNo], [StockCode], [LinkCode], [Description1], [Description2], [VATCode], [Units], [PackSize], [BarCode], [SuppCode], [CostExcl], [CostIncl], [FreeStockCode], [FreeLinkCode], [FreeDescription1], [FreeDescription2], [FreeQuantity], [FreePerQty], [MinBuy], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Notes] FROM [PURSuppDealDet]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [DealNo], [StockCode], [LinkCode], [Description1], [Description2], [VATCode], [Units], [PackSize], [BarCode], [SuppCode], [CostExcl], [CostIncl], [FreeStockCode], [FreeLinkCode], [FreeDescription1], [FreeDescription2], [FreeQuantity], [FreePerQty], [MinBuy], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Notes] FROM [PURSuppDealDet]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
