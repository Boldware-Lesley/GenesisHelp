...
Class is using the following global variables:
	...
	"public nvarchar DiscMthd" of type [nvarchar]
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [DealNo], [SequenceNo], [Description], [DiscMthd], [DiscType], [DiscValue], [Costed], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [PURSuppDealHdrDis]  WHERE [RecID]=:recid  ";
			...
			while($records  = $stmt->fetch( PDO::FETCH_ASSOC )) {
				...
				$instance->discmthd = $records["DiscMthd"];
