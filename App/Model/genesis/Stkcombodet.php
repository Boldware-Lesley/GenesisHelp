	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [ComboNo], [StockCode], [LinkCode], [VariantCode], [Description], [Quantity], [CostExcl], [CostIncl], [TotCostExcl], [TotCostIncl], [PercOfTotal], [SellExcl], [SellIncl], [TotalExcl], [TotalIncl], [DefSellExcl], [DefSellIncl], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [STKComboDet]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [ComboNo], [StockCode], [LinkCode], [VariantCode], [Description], [Quantity], [CostExcl], [CostIncl], [TotCostExcl], [TotCostIncl], [PercOfTotal], [SellExcl], [SellIncl], [TotalExcl], [TotalIncl], [DefSellExcl], [DefSellIncl], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [STKComboDet]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
