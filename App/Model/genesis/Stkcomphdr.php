	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [NAME], [COMNO], [PMCODE], [DESCRIPTION], [FROMDATE], [TODATE], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [STATUS] FROM [STKCompHDR]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_PMCODE($pmcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [NAME], [COMNO], [PMCODE], [DESCRIPTION], [FROMDATE], [TODATE], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [STATUS] FROM [STKCompHDR]  WHERE [PMCODE]=:pmcode  ";
			$stmt = $conn->getStatement($query);
