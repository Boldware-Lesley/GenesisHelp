	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [DateCount], [Status], [DTOAuth], [DTODate], [DTOTime], [DTOUser], [DTOMacID] FROM [STKDailyCntHdr]  WHERE [RecID]=:recid  ";
