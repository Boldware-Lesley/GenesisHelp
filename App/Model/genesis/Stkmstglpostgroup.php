	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [GroupCode], [Description], [SalesTaxable], [SalesExempt], [TradingStock], [CostOfSales], [StockAdjustment], [GoodRecvNotInvoiced] FROM [STKMstGLPostGroup]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_GroupCode($groupcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [GroupCode], [Description], [SalesTaxable], [SalesExempt], [TradingStock], [CostOfSales], [StockAdjustment], [GoodRecvNotInvoiced] FROM [STKMstGLPostGroup]  WHERE [GroupCode]=:groupcode  ";
			$stmt = $conn->getStatement($query);
