	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [PRCHGNO], [ACCOUNT], [STOCKCODE], [LINKCODE], [DESCRIPTION1], [OLDCOSTEXCL], [NEWCOSTEXCL], [OLDSELLEXCL], [NEWSELLEXCL], [PRCODE], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [OldDealExcl], [NewDealExcl], [DealPRCode], [Variant], [OldRebate], [NewRebate], [OldCostIncl], [NewCostIncl], [OldSellIncl], [NewSellIncl], [OldDealIncl], [NewDealIncl], [VATCode], [VATRate], [Units], [PurchaseItem], [ExpPRCode], [OldExpExcl], [OldExpIncl], [NewExpExcl], [NewExpIncl] FROM [STKPrChgDet]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_STOCKCODE($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [PRCHGNO], [ACCOUNT], [STOCKCODE], [LINKCODE], [DESCRIPTION1], [OLDCOSTEXCL], [NEWCOSTEXCL], [OLDSELLEXCL], [NEWSELLEXCL], [PRCODE], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID], [OldDealExcl], [NewDealExcl], [DealPRCode], [Variant], [OldRebate], [NewRebate], [OldCostIncl], [NewCostIncl], [OldSellIncl], [NewSellIncl], [OldDealIncl], [NewDealIncl], [VATCode], [VATRate], [Units], [PurchaseItem], [ExpPRCode], [OldExpExcl], [OldExpIncl], [NewExpExcl], [NewExpIncl] FROM [STKPrChgDet]  WHERE [STOCKCODE]=:stockcode  ";
			$stmt = $conn->getStatement($query);
