	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [PriceCode], [Description], [FromDate], [ToDate], [Excl], [Incl], [MUP], [GP], [DiscP], [DiscV], [MaxDiscP], [MaxDiscV], [MinGP], [PriceRule], [Rounding], [DefaultMUP], [DefaultGP], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Version] FROM [STKPrice_new1]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [PriceCode], [Description], [FromDate], [ToDate], [Excl], [Incl], [MUP], [GP], [DiscP], [DiscV], [MaxDiscP], [MaxDiscV], [MinGP], [PriceRule], [Rounding], [DefaultMUP], [DefaultGP], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [Version] FROM [STKPrice_new1]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
