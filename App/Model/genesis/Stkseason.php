	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [SEASONCODE], [DESCRIPTION], [SEASONSTART], [SEASONEND], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [STKSeason]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_SEASONCODE($seasoncode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [SEASONCODE], [DESCRIPTION], [SEASONSTART], [SEASONEND], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [STKSeason]  WHERE [SEASONCODE]=:seasoncode  ";
			$stmt = $conn->getStatement($query);
