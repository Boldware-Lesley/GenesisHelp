	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [TxTp], [TranDate], [AP], [DocNo], [RefNo], [Qty], [LinkQty], [Price], [Amount], [DrCr], [TaxAmount], [TaxRate], [TaxIndicator], [LastCostExcl], [LastCostIncl], [AvgCostExcl], [AvgCostIncl], [Adjustment], [Details], [Onhand], [WH], [RebateAmnt], [Supervisor], [BatchNo], [DTODate], [DTOTime], [DTOUser], [DTOMacID], [KitQty], [Version], [Units], [RebateAvgExcl], [lINEnO], [Cases] FROM [STKTxan_new]  WHERE [RecID]=:recid  ";
