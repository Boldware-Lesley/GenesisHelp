	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [VARIANTCODE], [DESCRIPTION], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [STKVariant]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_VARIANTCODE($variantcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [VARIANTCODE], [DESCRIPTION], [DTODATE], [DTOTIME], [DTOUSER], [DTOMACID] FROM [STKVariant]  WHERE [VARIANTCODE]=:variantcode  ";
			$stmt = $conn->getStatement($query);
