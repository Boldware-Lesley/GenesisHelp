	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [NAME], [GROUPCODE] FROM [SYNC_CRDMaster_1__132]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_GROUPCODE($groupcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [NAME], [GROUPCODE] FROM [SYNC_CRDMaster_1__132]  WHERE [GROUPCODE]=:groupcode  ";
			$stmt = $conn->getStatement($query);
