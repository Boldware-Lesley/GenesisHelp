	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [NAME], [GROUPCODE], [CORegNo] FROM [SYNC_CRDMaster_1__2344]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_GROUPCODE($groupcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [NAME], [GROUPCODE], [CORegNo] FROM [SYNC_CRDMaster_1__2344]  WHERE [GROUPCODE]=:groupcode  ";
			$stmt = $conn->getStatement($query);
