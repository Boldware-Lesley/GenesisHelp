	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TRANDATE], [TXTP], [AP], [AMOUNT], [DRCR], [GLTRACE] FROM [SYNC_CRDTxans_1__91]  WHERE [RECID]=:recid  ";
