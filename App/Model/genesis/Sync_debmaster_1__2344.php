	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [Name], [Status], [CreditLimit], [GroupCode], [TermFromValue], [CRMAccNo], [StmtFreq], [StmtFreqDOW], [PreAuthInd] FROM [SYNC_DEBMaster_1__2344]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_GroupCode($groupcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [Name], [Status], [CreditLimit], [GroupCode], [TermFromValue], [CRMAccNo], [StmtFreq], [StmtFreqDOW], [PreAuthInd] FROM [SYNC_DEBMaster_1__2344]  WHERE [GroupCode]=:groupcode  ";
			$stmt = $conn->getStatement($query);
