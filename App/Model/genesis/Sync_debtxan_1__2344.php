	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [TranDate], [AP], [TxTp], [Amount], [DrCr], [Gltrace] FROM [SYNC_DEBTxan_1__2344]  WHERE [RecID]=:recid  ";
