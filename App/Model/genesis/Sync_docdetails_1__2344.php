	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Quantity], [LineTotalExcl], [LineTotalIncl], [LinkQty], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [StockType], [AP], [Promotion], [DrCr], [RebAvgAmnt] FROM [SYNC_DOCDetails_1__2344]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Quantity], [LineTotalExcl], [LineTotalIncl], [LinkQty], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [StockType], [AP], [Promotion], [DrCr], [RebAvgAmnt] FROM [SYNC_DOCDetails_1__2344]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
