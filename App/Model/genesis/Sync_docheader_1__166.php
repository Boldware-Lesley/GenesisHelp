	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [DocNo], [Account], [TranDate], [TranTime], [DocDiscount], [TotalVAT], [TotalExcl], [TotalIncl], [TotalTaxable], [TotalExempt], [TotalCostExcl], [TotalCostIncl], [Profit], [AP], [TotalLineDisc], [TotalRebAmnt], [DrCr] FROM [SYNC_DOCHeader_1__166]  WHERE [RecID]=:recid  ";
