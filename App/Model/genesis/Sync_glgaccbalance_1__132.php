...
@Table			:	SYNC_GLGAccBalance_1__132
...
class Sync_glgaccbalance_1__132 {
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [GLAccNo], [AP], [Debit], [Credit], [SourceBranch] FROM [SYNC_GLGAccBalance_1__132]  WHERE [RecID]=:recid  ";
