	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [GLAccNo], [GLTrace], [AP], [TranDate], [TxTp], [Details], [Debit], [Credit], [DrCr], [SourceBranch], [Remarks], [Account], [DocNo], [Ref1], [Ref2], [Ref3] FROM [SYNC_GLGAccTxans_1__132]  WHERE [RecID]=:recid  ";
