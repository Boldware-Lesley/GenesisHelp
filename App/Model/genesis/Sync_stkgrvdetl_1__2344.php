	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TXTP], [GRVNO], [LINENO], [STOCKCODE], [LINKCODE], [STOCKTYPE], [RECVQTY], [RECVFREEQTY], [RECVPRICE], [RECVDISCOUNT], [RECVTOTAL], [RECVTAX], [RECVNETUNIT], [RECVNNET], [UNITS], [RECVTAXCODE], [RECVTOTALINCL], [AP] FROM [SYNC_STKGrvDetl_1__2344]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_STOCKCODE($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TXTP], [GRVNO], [LINENO], [STOCKCODE], [LINKCODE], [STOCKTYPE], [RECVQTY], [RECVFREEQTY], [RECVPRICE], [RECVDISCOUNT], [RECVTOTAL], [RECVTAX], [RECVNETUNIT], [RECVNNET], [UNITS], [RECVTAXCODE], [RECVTOTALINCL], [AP] FROM [SYNC_STKGrvDetl_1__2344]  WHERE [STOCKCODE]=:stockcode  ";
			$stmt = $conn->getStatement($query);
