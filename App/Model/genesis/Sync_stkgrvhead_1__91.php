	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [ACCOUNT], [TXTP], [GRVNO], [GRVDATE], [DOCNO], [DOCTOTALINCL], [DOCTOTALEXCL], [DOCTAX], [GRVTOTALEXCL], [GRVTOTALINCL], [GRVTAX], [GRVDISCOUNT], [TAXINDICATOR], [AP] FROM [SYNC_STKGrvHead_1__91]  WHERE [RECID]=:recid  ";
