	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [TxTp], [TranDate], [AP], [DocNo], [Qty], [LinkQty], [Price], [Amount], [DrCr], [TaxAmount], [AvgCostExcl], [AvgCostIncl], [RebateAmnt], [Units], [RebateAvgExcl] FROM [SYNC_STKTxan_1__132]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [StockCode], [LinkCode], [TxTp], [TranDate], [AP], [DocNo], [Qty], [LinkQty], [Price], [Amount], [DrCr], [TaxAmount], [AvgCostExcl], [AvgCostIncl], [RebateAmnt], [Units], [RebateAvgExcl] FROM [SYNC_STKTxan_1__132]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
