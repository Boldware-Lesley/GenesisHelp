...
@Table			:	syncobj_0x3933313436304137
...
class Syncobj_0x3933313436304137 {
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Quantity], [LineTotalExcl], [LineTotalIncl], [LinkQty], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [StockType], [AP], [Promotion], [DrCr], [RebAvgAmnt] FROM [syncobj_0x3933313436304137]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_StockCode($stockcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [TxTp], [DocNo], [Account], [TranDate], [StockCode], [LinkCode], [Quantity], [LineTotalExcl], [LineTotalIncl], [LinkQty], [TotalCostExcl], [TotalCostIncl], [Profit], [Units], [StockType], [AP], [Promotion], [DrCr], [RebAvgAmnt] FROM [syncobj_0x3933313436304137]  WHERE [StockCode]=:stockcode  ";
			$stmt = $conn->getStatement($query);
