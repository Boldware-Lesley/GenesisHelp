...
@Table			:	syncobj_0x3936373032464334
...
class Syncobj_0x3936373032464334 {
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [Name], [GroupCode] FROM [syncobj_0x3936373032464334]  WHERE [RecID]=:recid  ";
	...
	*/
	public static function ini_GroupCode($groupcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RecID, [CO], [Branch], [Account], [Name], [GroupCode] FROM [syncobj_0x3936373032464334]  WHERE [GroupCode]=:groupcode  ";
			$stmt = $conn->getStatement($query);
