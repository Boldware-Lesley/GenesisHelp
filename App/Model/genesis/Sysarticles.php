...
Class is using the following global variables:
	...
	"public boolean fire_triggers_on_snapshot" of type [boolean]
*/
namespace genesis;
	...
	*/
	public static function ini_RecID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT artid, [creation_script], [del_cmd], [description], [dest_table], [filter], [filter_clause], [ins_cmd], [name], [objid], [pubid], [pre_creation_cmd], [status], [sync_objid], [type], [upd_cmd], [schema_option], [dest_owner], [ins_scripting_proc], [del_scripting_proc], [upd_scripting_proc], [custom_script], [fire_triggers_on_snapshot] FROM [sysarticles]  WHERE [RecID]=:recid  ";
