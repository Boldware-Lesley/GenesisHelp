	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [USERGROUP], [MODCODE], [ACCESSNO], [OPTIONS], [CO] FROM [SYSGrpAccess]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_MODCODE($modcode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [USERGROUP], [MODCODE], [ACCESSNO], [OPTIONS], [CO] FROM [SYSGrpAccess]  WHERE [MODCODE]=:modcode  ";
			$stmt = $conn->getStatement($query);
