	...
	*/
	public static function ini_RECID($recid) {	
		...
		try {
			...
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [USERCODE], [MODCODE], [ACCESSNO], [OPTIONS] FROM [SYSUserAccess]  WHERE [RECID]=:recid  ";
	...
	*/
	public static function ini_USERCODE($usercode) {	
		...
		try {
			$conn = new MyConnection();
			$conn->Open();
			$query = " SELECT RECID, [CO], [BRANCH], [USERCODE], [MODCODE], [ACCESSNO], [OPTIONS] FROM [SYSUserAccess]  WHERE [USERCODE]=:usercode  ";
			$stmt = $conn->getStatement($query);
