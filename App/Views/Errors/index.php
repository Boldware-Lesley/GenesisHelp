...
<head>
    <meta charset="utf-8">
    <title><?php echo $app_server->AppName;?> - Latest Errors</title>
            ...
            <div class="container">
                ...
                <nav class="pull-right nav-collapse collapse">
                    <ul id="menu-main" class="nav">
                        <li><a title="PHP Info" href="<?php echo MAIN_URL;?>ErrorCodes">Error Codes</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="span12 aligncenter flyUp">
                <h2 class="pagetitle"><strong>Latest Errors</strong>, Week Number <strong><?php echo $todayWeek;?></strong></h2>
            </div>
        </div>
    </div>
</section>
...
<section id="maincontent" class="inner">
    <div class="container">
        ...
        <table style="width: 100%">
            ...
            <?php
            try {
                $query = "SELECT TOP 100 * FROM [vcAppStoreErrorLog] ORDER BY [TranDate] DESC,[TranTime] DESC; ";
                ...
                if(isset($stmt)) {
                    ...
                    if (isset($accVar)) {
                        foreach ($accVar as $row) {
                            ...
                            echo "<tr>";
                            echo "<td valign='top'>" . $row["AppID"] . "</td>";
                            echo "<td valign='top' align='center'><strong>" . $row["ErrorCode"] . "</strong></td>";
                            echo "<td valign='top'>";
                            echo "<strong>" . $row["ErrorTitle"] . "</strong><br>";
                            echo "<p>" . $row["ErrorText"] . "</p>";
                            echo "</td>";
                            echo "<td valign='top'>" . $row["TranDate"] . " " . $row["TranTime"] . "</td>";
                            echo "</tr>";
                ...
                echo "<tr>";
                echo "<td colspan='3'>Oops,".$ex->getMessage()."</td>";
                echo "</tr>";
            }
