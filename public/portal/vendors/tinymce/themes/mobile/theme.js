...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_9vqvcgy9jm0og3mp.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_9vqvcgy9jm0og3mp.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_9vqvcgy9jm0og3mp.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_44arnbyejm0og3n7 = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_44arnbyejm0og3n7.browsers();
    var oses = $_44arnbyejm0og3n7.oses();
    var browser = $_y0cctycjm0og3mx.detectBrowser(browsers, userAgent).fold($_4cxs2wy8jm0og3mm.unknown, $_4cxs2wy8jm0og3mm.nu);
    var os = $_y0cctycjm0og3mx.detectOs(oses, userAgent).fold($_13wu9yajm0og3mq.unknown, $_13wu9yajm0og3mq.nu);
  ...
  var $_4rnfr2y7jm0og3mk = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_4rnfr2y7jm0og3mk.detect(userAgent);
  });
  var $_6rwovay4jm0og3m3 = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_6rwovay4jm0og3m3.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_ep0l9aymjm0og3ol.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_ep0l9aymjm0og3ol.ELEMENT);
  var isText = isType$1($_ep0l9aymjm0og3ol.TEXT);
  var isDocument = isType$1($_ep0l9aymjm0og3ol.DOCUMENT);
  var $_b2jnxtyljm0og3oj = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_b2jnxtyljm0og3oj.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_2n1mveytjm0og3pb = { toArray: toArray };
  ...
  var $_5lx8faywjm0og3pu = { getOrDie: getOrDie };

  var node = function () {
    var f = $_5lx8faywjm0og3pu.getOrDie('Node');
    return f;
  };
  ...
  var $_634zrnyvjm0og3pt = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_ep0l9aymjm0og3ol.ELEMENT;
  var DOCUMENT = $_ep0l9aymjm0og3ol.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_634zrnyvjm0og3pt.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_6rwovay4jm0og3m3.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_6hgie2yujm0og3pc = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_fancv8yzjm0og3pz.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_6hgie2yujm0og3pc.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_6hgie2yujm0og3pc.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_2n1mveytjm0og3pb.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_2n1mveytjm0og3pb.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_8q7k44yojm0og3oq.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_8q7k44yojm0og3oq.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_8q7k44yojm0og3oq.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_8q7k44yojm0og3oq.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_7p4pskynjm0og3on.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_7p4pskynjm0og3on.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_7p4pskynjm0og3on.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_7p4pskynjm0og3on.append(parent, x);
    });
  };
  var $_65q9xbz1jm0og3qb = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_8q7k44yojm0og3oq.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_8q7k44yojm0og3oq.children(wrapper);
    if (children.length > 0)
      $_65q9xbz1jm0og3qb.before(wrapper, children);
    remove(wrapper);
  };
  var $_5sc6ouz0jm0og3q6 = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_7p4pskynjm0og3on.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_g8rdm6yjjm0og3o4.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_5sc6ouz0jm0og3q6.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_8q7k44yojm0og3oq.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_5sc6ouz0jm0og3q6.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_7p4pskynjm0og3on.append(element, guiSystem.element());
    var children = $_8q7k44yojm0og3oq.children(guiSystem.element());
  ...
  var json = function () {
    return $_5lx8faywjm0og3pu.getOrDie('JSON');
  };
  ...
  var $_5qj2y6zijm0og3ti = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_5qj2y6zijm0og3ti.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_6hgie2yujm0og3pc.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_5qj2y6zijm0og3ti.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_5qj2y6zijm0og3ti.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_5qj2y6zijm0og3ti.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_b2jnxtyljm0og3oj.isElement(source) || !$_b2jnxtyljm0og3oj.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_4usw6ozxjm0og3wq = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_4usw6ozxjm0og3wq.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_4usw6ozxjm0og3wq.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_4usw6ozxjm0og3wq.remove(element, attr);
    return false;
  };
  var $_apxevgzzjm0og3x4 = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_apxevgzzjm0og3x4.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_apxevgzzjm0og3x4.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_apxevgzzjm0og3x4.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_cbw1e3zyjm0og3wz.supports(element))
      element.dom().classList.add(clazz);
    else
      $_cbw1e3zyjm0og3wz.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_cbw1e3zyjm0og3wz.supports(element) ? element.dom().classList : $_cbw1e3zyjm0og3wz.get(element);
    if (classList.length === 0) {
      $_4usw6ozxjm0og3wq.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_cbw1e3zyjm0og3wz.supports(element)) {
      ...
      $_cbw1e3zyjm0og3wz.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_cbw1e3zyjm0og3wz.supports(element) ? element.dom().classList.toggle(clazz) : $_cbw1e3zyjm0og3wz.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_cbw1e3zyjm0og3wz.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_cbw1e3zyjm0og3wz.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_8zzwgvzvjm0og3wl = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_8zzwgvzvjm0og3wl.remove(element, removeCls);
    $_8zzwgvzvjm0og3wl.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_8zzwgvzvjm0og3wl.remove(component.element(), swapConfig.alpha());
    $_8zzwgvzvjm0og3wl.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_8zzwgvzvjm0og3wl.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_8zzwgvzvjm0og3wl.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_g8rdm6yjjm0og3o4.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_6hgie2yujm0og3pc.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_6s1lcw104jm0og3xn.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_6s1lcw104jm0og3xn.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_6s1lcw104jm0og3xn.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_6s1lcw104jm0og3xn.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_6s1lcw104jm0og3xn.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_6s1lcw104jm0og3xn.descendant(scope, predicate).isSome();
  };
  var $_6m15et103jm0og3xm = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_8q7k44yojm0og3oq.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_8q7k44yojm0og3oq.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_6m15et103jm0og3xm.closest(a, curry($_6hgie2yujm0og3pc.eq, element));
    });
  ...
  var search = function (element) {
    return active($_8q7k44yojm0og3oq.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_7mppn3102jm0og3xc = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_3plipl108jm0og3yc = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_8q7k44yojm0og3oq.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_8q7k44yojm0og3oq.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_acyblt10hjm0og3ze.fromHtml(content, docDom);
    $_65q9xbz1jm0og3qb.append(fragment, contentElements);
    $_5sc6ouz0jm0og3q6.empty(element);
    $_7p4pskynjm0og3on.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_7p4pskynjm0og3on.append(container, clone);
    return get$2(container);
  };
  var $_98ykl810gjm0og3zc = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_4usw6ozxjm0og3wq.clone(original);
    $_4usw6ozxjm0og3wq.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_8q7k44yojm0og3oq.children(deep$1(original));
    $_65q9xbz1jm0og3qb.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_7p4pskynjm0og3on.before(original, nu);
    var children = $_8q7k44yojm0og3oq.children(original);
    $_65q9xbz1jm0og3qb.append(nu, children);
    $_5sc6ouz0jm0og3q6.remove(original);
    return nu;
  };
  var $_gg5boc10ijm0og3zj = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_gg5boc10ijm0og3zj.shallow(element);
    return $_98ykl810gjm0og3zc.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_8zzwgvzvjm0og3wl.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_8zzwgvzvjm0og3wl.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_8zzwgvzvjm0og3wl.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_8zzwgvzvjm0og3wl.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_8q8ecd10ajm0og3yg.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_8q8ecd10ajm0og3yg.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_6rwovay4jm0og3m3.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_7mppn3102jm0og3xc.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_7mppn3102jm0og3xc.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_7mppn3102jm0og3xc.hasFocus(component.element());
  };
  ...
  var $_bosi7z118jm0og44q = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_bosi7z118jm0og44q.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_g8rdm6yjjm0og3o4.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_bosi7z118jm0og44q.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_4usw6ozxjm0og3wq.has(element, 'style') && trim($_4usw6ozxjm0og3wq.get(element, 'style')) === '') {
      $_4usw6ozxjm0og3wq.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_4usw6ozxjm0og3wq.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_4usw6ozxjm0og3wq.remove : $_4usw6ozxjm0og3wq.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_bosi7z118jm0og44q.isSupported(sourceDom) && $_bosi7z118jm0og44q.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_a9fc7d117jm0og44d.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_a9fc7d117jm0og44d.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_g8rdm6yjjm0og3o4.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_a9fc7d117jm0og44d.set(element, 'max-height', absMax + 'px');
  };
  var $_gg73a116jm0og44b = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_g8rdm6yjjm0og3o4.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_8q7k44yojm0og3oq.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_8q7k44yojm0og3oq.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_8q7k44yojm0og3oq.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_8q7k44yojm0og3oq.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_fancv8yzjm0og3pz.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_fffzsz11bjm0og44z.ancestors(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_fffzsz11bjm0og44z.siblings(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_fffzsz11bjm0og44z.children(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_fancv8yzjm0og3pz.all(selector, scope);
  };
  var $_81v3cq11ajm0og44y = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_fancv8yzjm0og3pz.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_6s1lcw104jm0og3xn.ancestor(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_6s1lcw104jm0og3xn.sibling(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_6s1lcw104jm0og3xn.child(scope, function (e) {
      return $_fancv8yzjm0og3pz.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_fancv8yzjm0og3pz.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_fancv8yzjm0og3pz.is, ancestor$2, scope, selector, isRoot);
  };
  var $_5pjeb711cjm0og452 = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_81v3cq11ajm0og44y.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_8zzwgvzvjm0og3wl.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_8zzwgvzvjm0og3wl.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_8zzwgvzvjm0og3wl.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_81v3cq11ajm0og44y.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_8zzwgvzvjm0og3wl.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_5pjeb711cjm0og452.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_5pjeb711cjm0og452.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_8zzwgvzvjm0og3wl.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_7mppn3102jm0og3xc.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_5pjeb711cjm0og452.closest(element, sel);
      }).getOr(element);
      return $_gg73a116jm0og44b.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_81v3cq11ajm0og44y.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_5pjeb711cjm0og452.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_6hgie2yujm0og3pc.eq, tabstop));
  ...
  var inside = function (target) {
    return $_b2jnxtyljm0og3oj.name(target) === 'input' && $_4usw6ozxjm0og3wq.get(target, 'type') !== 'radio' || $_b2jnxtyljm0og3oj.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_a9fc7d117jm0og44d.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_384pf611ujm0og482 = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_384pf611ujm0og482.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_384pf611ujm0og482.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_a9fc7d117jm0og44d.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_a9fc7d117jm0og44d.set, element, property, initial);
    var on = curry($_a9fc7d117jm0og44d.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_endekh11wjm0og48f.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_6hgie2yujm0og3pc.eq, current);
    var candidates = $_81v3cq11ajm0og44y.descendants(container, selector);
    var visible = filter(candidates, $_endekh11wjm0og48f.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_6hgie2yujm0og3pc.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_5pjeb711cjm0og452.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_5pjeb711cjm0og452.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_5pjeb711cjm0og452.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_5pjeb711cjm0og452.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_5pjeb711cjm0og452.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_7mppn3102jm0og3xc.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_81v3cq11ajm0og44y.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_5pjeb711cjm0og452.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_81v3cq11ajm0og44y.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_81v3cq11ajm0og44y.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_5pjeb711cjm0og452.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_5qj2y6zijm0og3ti.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_5qj2y6zijm0og3ti.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_4usw6ozxjm0og3wq.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_4usw6ozxjm0og3wq.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_b2jnxtyljm0og3oj.isElement(elem) ? $_4usw6ozxjm0og3wq.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_8q7k44yojm0og3oq.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_98ykl810gjm0og3zc.get(elem) };
    return deepMerge({
      tag: $_b2jnxtyljm0og3oj.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_ajqgnq10ujm0og42c.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_ajqgnq10ujm0og42c.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_3w7a9o10tjm0og428.format(command, function (button, status) {
  ...
  var isTouch = $_6rwovay4jm0og3m3.detect().deviceType.isTouch();
  ...
  var platform = $_6rwovay4jm0og3m3.detect();
  ...
  var isTouch$2 = $_6rwovay4jm0og3m3.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_a9fc7d117jm0og44d.set(element, 'max-width', absMax + 'px');
  };
  var $_bjiknc131jm0og4ir = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_6rwovay4jm0og3m3.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_bjiknc131jm0og4ir.get(thumb.element()) / 2;
      $_a9fc7d117jm0og44d.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_a9fc7d117jm0og44d.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_1lqpb110vjm0og42f.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_a9fc7d117jm0og44d.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_ajqgnq10ujm0og42c.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_3w7a9o10tjm0og428.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_ajqgnq10ujm0og42c.resolve('slider-' + spec$$1.category + '-size-container'),
          $_ajqgnq10ujm0og42c.resolve('slider'),
          $_ajqgnq10ujm0og42c.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_dvu2dh134jm0og4ix = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_b2jnxtyljm0og3oj.isElement(rawStart) ? Option.some(rawStart) : $_8q7k44yojm0og3oq.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_6s1lcw104jm0og3xn.closest(start, function (elem) {
        return $_a9fc7d117jm0og44d.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_a9fc7d117jm0og44d.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_a9fc7d117jm0og44d.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_6hgie2yujm0og3pc.eq(root, e);
    };
  ...
  var $_flowp1135jm0og4jc = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_flowp1135jm0og4jc.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_dvu2dh134jm0og4ix.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_flowp1135jm0og4jc.apply(editor, value);
      },
      getInitialValue: function () {
        return $_flowp1135jm0og4jc.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_5lx8faywjm0og3pu.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_5lx8faywjm0og3pu.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_5lx8faywjm0og3pu.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_5lx8faywjm0og3pu.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_5lx8faywjm0og3pu.getOrDie('atob');
    return f(base64);
  };
  var $_gg3etr13gjm0og4ld = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_gg3etr13gjm0og4ld.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_e3lwr013ajm0og4kz.create($_d802i813bjm0og4l4.getWidth(image), $_d802i813bjm0og4l4.getHeight(image));
      context = $_e3lwr013ajm0og4kz.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_30wri9139jm0og4kj.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_30wri9139jm0og4kj.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_30wri9139jm0og4kj.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_30wri9139jm0og4kj.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_30wri9139jm0og4kj.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_30wri9139jm0og4kj.uriToBlob(uri));
  };
  var $_avqqg2138jm0og4ke = {
  ...
  var addImage = function (editor, blob) {
    $_avqqg2138jm0og4ke.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_einnvu13jjm0og4ly.get(link);
    var url = $_4usw6ozxjm0og3wq.get(link, 'href');
    var title = $_4usw6ozxjm0og3wq.get(link, 'title');
    var target = $_4usw6ozxjm0og3wq.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_4usw6ozxjm0og3wq.get(link, 'href');
    var prevText = $_einnvu13jjm0og4ly.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_4usw6ozxjm0og3wq.setAll(link, attrs);
        text.each(function (newText) {
          $_einnvu13jjm0og4ly.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_5pjeb711cjm0og452.closest(start, 'a');
  };
  var $_6dhdxf13ijm0og4lm = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_6rwovay4jm0og3m3.detect();
  ...
  var $_8jcvye13kjm0og4lz = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_9evj3x13ujm0og4o3.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_9evj3x13ujm0og4o3.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_9evj3x13ujm0og4o3.get(input.element());
            if (current !== data) {
              $_9evj3x13ujm0og4o3.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_ajqgnq10ujm0og42c.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_b2jnxtyljm0og3oj.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_4usw6ozxjm0og3wq.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_4usw6ozxjm0og3wq.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_4usw6ozxjm0og3wq.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_4usw6ozxjm0og3wq.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_8zzwgvzvjm0og3wl.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_8zzwgvzvjm0og3wl.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_ajqgnq10ujm0og42c.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_5pjeb711cjm0og452.descendant(dialog.element(), '.' + $_ajqgnq10ujm0og42c.resolve('serialised-dialog-chain')).each(function (parent) {
        $_a9fc7d117jm0og44d.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_81v3cq11ajm0og44y.descendants(dialog.element(), '.' + $_ajqgnq10ujm0og42c.resolve('serialised-dialog-screen'));
      $_5pjeb711cjm0og452.descendant(dialog.element(), '.' + $_ajqgnq10ujm0og42c.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_a9fc7d117jm0og44d.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_bjiknc131jm0og4ir.get(screens[0]);
            $_a9fc7d117jm0og44d.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_81v3cq11ajm0og44y.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_3w7a9o10tjm0og428.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_ajqgnq10ujm0og42c.resolve('dot-active'),
          itemClass: $_ajqgnq10ujm0og42c.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_1dvloi145jm0og4qj.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_1dvloi145jm0og4qj.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_1dvloi145jm0og4qj.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_6dhdxf13ijm0og4lm.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_6dhdxf13ijm0og4lm.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_1lqpb110vjm0og42f.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_8jcvye13kjm0og4lz.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_6dhdxf13ijm0og4lm.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_6hgie2yujm0og3pc.eq(originator, component.element()) && !$_6hgie2yujm0og3pc.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_5qj2y6zijm0og3ti.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_5qj2y6zijm0og3ti.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_5qj2y6zijm0og3ti.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_5qj2y6zijm0og3ti.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_5qj2y6zijm0og3ti.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_8zzwgvzvjm0og3wl.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_8zzwgvzvjm0og3wl.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_8zzwgvzvjm0og3wl.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_8zzwgvzvjm0og3wl.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_cbw1e3zyjm0og3wz.supports(element) ? getNative(element) : $_cbw1e3zyjm0og3wz.get(element);
  };
  var $_bc1ia014njm0og4wx = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_4usw6ozxjm0og3wq.setAll(subject, definition.attributes().getOr({}));
    $_bc1ia014njm0og4wx.add(subject, definition.classes().getOr([]));
    $_a9fc7d117jm0og44d.setAll(subject, definition.styles().getOr({}));
    $_98ykl810gjm0og3zc.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_65q9xbz1jm0og3qb.append(subject, children);
    definition.value().each(function (value) {
      $_9evj3x13ujm0og4o3.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_8q7k44yojm0og3oq.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_5qj2y6zijm0og3ti.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_7mppn3102jm0og3xc.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_8q7k44yojm0og3oq.owner(container);
    var refocus = $_7mppn3102jm0og3xc.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_6hgie2yujm0og3pc.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_6s1lcw104jm0og3xn.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_7mppn3102jm0og3xc.active(ownerDoc).filter(function (newFocus) {
        return $_6hgie2yujm0og3pc.eq(newFocus, oldFocus);
      }).fold(function () {
        $_7mppn3102jm0og3xc.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_7p4pskynjm0og3on.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_7p4pskynjm0og3on.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_6hgie2yujm0og3pc.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_8zzwgvzvjm0og3wl.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_g8rdm6yjjm0og3o4.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_bc1ia014njm0og4wx.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_bc1ia014njm0og4wx.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_5pjeb711cjm0og452.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_8zzwgvzvjm0og3wl.remove(comp.element(), t.transitionClass());
      $_4usw6ozxjm0og3wq.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_4usw6ozxjm0og3wq.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_4usw6ozxjm0og3wq.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_4usw6ozxjm0og3wq.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_4usw6ozxjm0og3wq.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_4usw6ozxjm0og3wq.has(comp.element(), transConfig.stateAttr()) && $_4usw6ozxjm0og3wq.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_4usw6ozxjm0og3wq.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_4usw6ozxjm0og3wq.has(comp.element(), transConfig.destinationAttr())) {
      $_4usw6ozxjm0og3wq.set(comp.element(), transConfig.stateAttr(), $_4usw6ozxjm0og3wq.get(comp.element(), transConfig.destinationAttr()));
      $_4usw6ozxjm0og3wq.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_8zzwgvzvjm0og3wl.add(comp.element(), t.transitionClass());
      $_4usw6ozxjm0og3wq.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_4usw6ozxjm0og3wq.has(e, transConfig.stateAttr()) ? Option.some($_4usw6ozxjm0og3wq.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_ajqgnq10ujm0og42c.resolve('scrollable');
  var register = function (element) {
    $_8zzwgvzvjm0og3wl.add(element, scrollable);
  };
  var deregister = function (element) {
    $_8zzwgvzvjm0og3wl.remove(element, scrollable);
  };
  var $_3k7nkg15ajm0og52n = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_ajqgnq10ujm0og42c.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_ajqgnq10ujm0og42c.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_3w7a9o10tjm0og428.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_ajqgnq10ujm0og42c.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_ajqgnq10ujm0og42c.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_ajqgnq10ujm0og42c.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_a9fc7d117jm0og44d.set(component.element(), 'overflow-y', 'auto');
                $_a9fc7d117jm0og44d.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_3k7nkg15ajm0og52n.register(component.element());
              }),
              runOnDetached(function (component) {
                $_a9fc7d117jm0og44d.remove(component.element(), 'overflow-y');
                $_a9fc7d117jm0og44d.remove(component.element(), '-webkit-overflow-scrolling');
                $_3k7nkg15ajm0og52n.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_ajqgnq10ujm0og42c.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_bjiknc131jm0og4ir.get(container.element());
        $_bjiknc131jm0og4ir.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_bjiknc131jm0og4ir.get(container.element());
        var menu = $_5pjeb711cjm0og452.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_bjiknc131jm0og4ir.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_5pjeb711cjm0og452.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_ajqgnq10ujm0og42c.resolve('styles-background-menu'),
        menu: $_ajqgnq10ujm0og42c.resolve('styles-menu'),
        selectedMenu: $_ajqgnq10ujm0og42c.resolve('styles-selected-menu'),
        item: $_ajqgnq10ujm0og42c.resolve('styles-item'),
        selectedItem: $_ajqgnq10ujm0og42c.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_9ttzgw148jm0og4r5 = { sketch: sketch$9 };
  ...
  var $_7wwnw215bjm0og52s = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_7wwnw215bjm0og52s.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_9ttzgw148jm0og4r5.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_1lqpb110vjm0og42f.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_1lqpb110vjm0og42f.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_1lqpb110vjm0og42f.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_36drgc12ljm0og4fq.sketch(realm, editor);
    };
    var styleFormats = $_ufa45146jm0og4qm.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_ufa45146jm0og4qm.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_1lqpb110vjm0og42f.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_3w7a9o10tjm0og428.receive($_8q8ecd10ajm0og3yg.orientationChanged(), Toggling.off),
            $_3w7a9o10tjm0og428.receive($_8q8ecd10ajm0og3yg.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_1q4fc815ejm0og53d.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_1q4fc815ejm0og53d.capture(element, event, filter$1, handler);
  };
  var $_6rgkdf15djm0og539 = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_6rwovay4jm0og3m3.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_6rgkdf15djm0og539.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_6hgie2yujm0og3pc.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_6rgkdf15djm0og539.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_6rgkdf15djm0og539.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_2vmn8915jjm0og54q = { monitor: monitor$1 };

  var isAndroid6 = $_6rwovay4jm0og3m3.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_2vmn8915jjm0og54q.monitor(editorApi);
    var outerDoc = $_8q7k44yojm0og3oq.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_6hgie2yujm0og3pc.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_7mppn3102jm0og3xc.active(outerDoc).filter(function (input) {
        return $_b2jnxtyljm0og3oj.name(input) === 'input';
    ...
    var listeners = [
      $_6rgkdf15djm0og539.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_6rgkdf15djm0og539.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_7mppn3102jm0og3xc.blur(editorApi.body());
      }),
      ...
      $_6rgkdf15djm0og539.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_6rgkdf15djm0og539.bind(outerDoc, 'select', updateMargin),
      $_6rgkdf15djm0og539.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_d19w5t15ijm0og542 = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_4usw6ozxjm0og3wq.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_153ir215njm0og55l = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_b2jnxtyljm0og3oj.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_b2jnxtyljm0og3oj.name(element) === 'img' ? 1 : $_3nx3ch15qjm0og563.getOption(element).fold(function () {
      return $_8q7k44yojm0og3oq.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_3nx3ch15qjm0og563.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_b2jnxtyljm0og3oj.name(elem));
  };
  var $_8lvzxn15pjm0og55z = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_ftdftf15tjm0og56j.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_8q7k44yojm0og3oq.defaultView(start);
  };
  var $_1u5cvv15sjm0og56d = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_8q7k44yojm0og3oq.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_6hgie2yujm0og3pc.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_96iou715vjm0og56v = {
    after: after$2,
  ...
  var $_5wkbkn15wjm0og56x = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_cf4mlp15xjm0og571.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_cf4mlp15xjm0og571.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_3nx3ch15qjm0og563.get(textnode).length;
    var offset = $_e3cyxk161jm0og57t.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_e3cyxk161jm0og57t.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_ayeupo162jm0og57v = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_8q7k44yojm0og3oq.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_e3cyxk161jm0og57t.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_b2jnxtyljm0og3oj.isText(node) ? $_ayeupo162jm0og57v.locate : searchInChildren;
  ...
  var $_ee7epu160jm0og57n = { locate: locate$2 };

  var first$3 = function (element) {
    return $_6s1lcw104jm0og3xn.descendant(element, $_8lvzxn15pjm0og55z.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_8lvzxn15pjm0og55z.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_8q7k44yojm0og3oq.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_bum42m164jm0og58a.first : $_bum42m164jm0og58a.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_8q7k44yojm0og3oq.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_a5wd5x163jm0og586 = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_ee7epu160jm0og57n.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_a5wd5x163jm0og586.search(doc, elem, x);
      };
      return $_8q7k44yojm0og3oq.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_1u5cvv15sjm0og56d.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_bxwi1o15zjm0og57j = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_cf4mlp15xjm0og571.create(win);
    var self = $_fancv8yzjm0og3pz.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_81v3cq11ajm0og44y.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_cf4mlp15xjm0og571.selectNodeContentsUsing(innerRange, elem);
      return $_cf4mlp15xjm0og571.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_b2jnxtyljm0og3oj.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_6c657u165jm0og58e = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_b2jnxtyljm0og3oj.name(element);
    if ('input' === name)
      return $_ftdftf15tjm0og56j.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_ftdftf15tjm0og56j.on(element, offset);
    else
      return offset === 0 ? $_ftdftf15tjm0og56j.before(element) : $_ftdftf15tjm0og56j.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_ftdftf15tjm0og56j.before, beforeSpecial, $_ftdftf15tjm0og56j.after);
    var finish = finishSitu.fold($_ftdftf15tjm0og56j.before, beforeSpecial, $_ftdftf15tjm0og56j.after);
    return $_1u5cvv15sjm0og56d.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_1u5cvv15sjm0og56d.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_cf4mlp15xjm0og571.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_6c657u165jm0og58e.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_5x5c0x15yjm0og578.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_4nmvis166jm0og58i.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_4nmvis166jm0og58i.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_1u5cvv15sjm0og56d.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_cf4mlp15xjm0og571.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_4nmvis166jm0og58i.preprocess(selection);
    return $_5x5c0x15yjm0og578.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_1u5cvv15sjm0og56d.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_96iou715vjm0og56v.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_1u5cvv15sjm0og56d.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_cf4mlp15xjm0og571.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_1u5cvv15sjm0og56d.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    return $_cf4mlp15xjm0og571.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    return $_cf4mlp15xjm0og571.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_bxwi1o15zjm0og57j.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    return $_cf4mlp15xjm0og571.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    return $_cf4mlp15xjm0og571.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    var fragment = $_5wkbkn15wjm0og56x.fromElements(elements, win.document);
    $_cf4mlp15xjm0og571.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_5x5c0x15yjm0og578.asLtrRange(win, selection);
    $_cf4mlp15xjm0og571.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_6hgie2yujm0og3pc.eq(start, finish) && soffset === foffset;
  };
  var $_83he7c15ujm0og56p = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_8q7k44yojm0og3oq.parent(start_1).bind(function (parent) {
        var selection = $_1u5cvv15sjm0og56d.exact(start_1, range$$1.startOffset, parent, $_8lvzxn15pjm0og55z.getEnd(parent));
        var optRect = $_83he7c15ujm0og56p.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_4ijcf115ojm0og55n = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_7mppn3102jm0og3xc.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_b2jnxtyljm0og3oj.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_7mppn3102jm0og3xc.active().each($_7mppn3102jm0og3xc.blur);
      $_7mppn3102jm0og3xc.focus(iBody);
    });
  };
  var $_52y252167jm0og58n = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_ajqgnq10ujm0og42c.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_4usw6ozxjm0og3wq.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_153ir215njm0og55l.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_4ijcf115ojm0og55n.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_52y252167jm0og58n.resume(cWin);
    };
    var onResize = $_6rgkdf15djm0og539.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_17zit015mjm0og55a = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_83he7c15ujm0og56p.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_6rgkdf15djm0og539.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_83he7c15ujm0og56p.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_83he7c15ujm0og56p.get(win).bind(function (sel) {
                return $_83he7c15ujm0og56p.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_83he7c15ujm0og56p.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_83he7c15ujm0og56p.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_6rwovay4jm0og3m3.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_a9fc7d117jm0og44d.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_81v3cq11ajm0og44y.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_4usw6ozxjm0og3wq.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {

        } else {
          $_4usw6ozxjm0og3wq.set(element, attr, backup);
          $_4usw6ozxjm0og3wq.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_81v3cq11ajm0og44y.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_81v3cq11ajm0og44y.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_4usw6ozxjm0og3wq.get(element, attr);
      if (restore !== 'no-styles') {
        $_4usw6ozxjm0og3wq.set(element, 'style', restore);
      } else {
        $_4usw6ozxjm0og3wq.remove(element, 'style');
      }
      $_4usw6ozxjm0og3wq.remove(element, attr);
  ...
  var $_3umfqf169jm0og59a = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_5pjeb711cjm0og452.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_4usw6ozxjm0og3wq.set(meta, 'name', 'viewport');
      $_7p4pskynjm0og3on.append(head, meta);
      return meta;
    };
    var element = $_5pjeb711cjm0og452.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_4usw6ozxjm0og3wq.get(element, 'content');
    var maximize = function () {
      $_4usw6ozxjm0og3wq.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_4usw6ozxjm0og3wq.set(element, 'content', backup);
      } else {
        $_4usw6ozxjm0og3wq.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_7tdxxi16ajm0og59k = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_7tdxxi16ajm0og59k.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_8zzwgvzvjm0og3wl.add(platform.container, $_ajqgnq10ujm0og42c.resolve('fullscreen-maximized'));
      $_8zzwgvzvjm0og3wl.add(platform.container, $_ajqgnq10ujm0og42c.resolve('android-maximized'));
      meta.maximize();
      $_8zzwgvzvjm0og3wl.add(platform.body, $_ajqgnq10ujm0og42c.resolve('android-scroll-reload'));
      androidApi.set($_17zit015mjm0og55a.setup(platform.win, $_5wkdr9168jm0og58x.getWin(platform.editor).getOrDie('no')));
      $_5wkdr9168jm0og58x.getActiveApi(platform.editor).each(function (editorApi) {
        $_3umfqf169jm0og59a.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_d19w5t15ijm0og542.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_8zzwgvzvjm0og3wl.remove(platform.container, $_ajqgnq10ujm0og42c.resolve('fullscreen-maximized'));
      $_8zzwgvzvjm0og3wl.remove(platform.container, $_ajqgnq10ujm0og42c.resolve('android-maximized'));
      $_3umfqf169jm0og59a.restoreStyles();
      $_8zzwgvzvjm0og3wl.remove(platform.body, $_ajqgnq10ujm0og42c.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_eo83hm15hjm0og53x = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_ajqgnq10ujm0og42c.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_ajqgnq10ujm0og42c.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_c8hipz16bjm0og59z = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_8q7k44yojm0og3oq.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_a9fc7d117jm0og44d.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_c8hipz16bjm0og59z.sketch(onTap, mobile.translate));
    ...
    $_7p4pskynjm0og3on.append(mobile.container, mask.element());
    var mode = $_eo83hm15hjm0og53x.create(mobile, maskApi);
    return {
  ...
  var $_145tcj15gjm0og53o = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_ajqgnq10ujm0og42c.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_4usw6ozxjm0og3wq.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_4usw6ozxjm0og3wq.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_6rgkdf15djm0og539.bind(scope, 'touchmove', function (event) {
      $_5pjeb711cjm0og452.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_1zm8tn16jjm0og5c6 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_a9fc7d117jm0og44d.set(component.element(), 'overflow-x', 'auto');
              $_1zm8tn16jjm0og5c6.markAsHorizontal(component.element());
              $_3k7nkg15ajm0og52n.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_ajqgnq10ujm0og42c.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_ajqgnq10ujm0og42c.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_ajqgnq10ujm0og42c.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_ajqgnq10ujm0og42c.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_bc1ia014njm0og4wx.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_8zzwgvzvjm0og3wl.remove(component.element(), slideConfig.openClass());
    $_8zzwgvzvjm0og3wl.add(component.element(), slideConfig.closedClass());
    $_a9fc7d117jm0og44d.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_a9fc7d117jm0og44d.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_8zzwgvzvjm0og3wl.remove(component.element(), slideConfig.closedClass());
    $_8zzwgvzvjm0og3wl.add(component.element(), slideConfig.openClass());
    $_a9fc7d117jm0og44d.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_a9fc7d117jm0og44d.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_a9fc7d117jm0og44d.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_a9fc7d117jm0og44d.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_8zzwgvzvjm0og3wl.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_8zzwgvzvjm0og3wl.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_a9fc7d117jm0og44d.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_8zzwgvzvjm0og3wl.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_8zzwgvzvjm0og3wl.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_a9fc7d117jm0og44d.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_bjiknc131jm0og4ir.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_gg73a116jm0og44b.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_ajqgnq10ujm0og42c.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_ajqgnq10ujm0og42c.resolve('dropup-closed'),
          openClass: $_ajqgnq10ujm0og42c.resolve('dropup-open'),
          shrinkingClass: $_ajqgnq10ujm0og42c.resolve('dropup-shrinking'),
          growingClass: $_ajqgnq10ujm0og42c.resolve('dropup-growing'),
        ...
        $_3w7a9o10tjm0og428.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_b2jnxtyljm0og3oj.name(event$$1.target()));
  };
  var isFirefox = $_6rwovay4jm0og3m3.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_6rgkdf15djm0og539.capture(container, 'focus', handler);
    } else {
      return $_6rgkdf15djm0og539.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_6rgkdf15djm0og539.capture(container, 'blur', handler);
    } else {
      return $_6rgkdf15djm0og539.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_6rwovay4jm0og3m3.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_6rgkdf15djm0og539.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_6rgkdf15djm0og539.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_8q7k44yojm0og3oq.defaultView(container);
    var onWindowScroll = $_6rgkdf15djm0og539.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_8q7k44yojm0og3oq.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_6s1lcw104jm0og3xn.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_g8rdm6yjjm0og3o4.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_8q7k44yojm0og3oq.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_6hgie2yujm0og3pc.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_7mppn3102jm0og3xc.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_b2jnxtyljm0og3oj.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_5sc6ouz0jm0og3q6.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_ajqgnq10ujm0og42c.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_ajqgnq10ujm0og42c.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_ajqgnq10ujm0og42c.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_ajqgnq10ujm0og42c.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_bp6e7b16kjm0og5cf.makeEditSwitch(webapp);
    var socket = $_bp6e7b16kjm0og5cf.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_145tcj15gjm0og53o.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_bp6e7b16kjm0og5cf.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_a9fc7d117jm0og44d.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_7p4pskynjm0og3on.append(parent, input);
    $_7mppn3102jm0og3xc.focus(input);
    operation(input);
    $_5sc6ouz0jm0og3q6.remove(input);
  };
  var $_x602b174jm0og5if = { input: input$1 };
  ...
  var $_3btyzc176jm0og5iv = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_7mppn3102jm0og3xc.active().each(function (active) {
      if (!$_6hgie2yujm0og3pc.eq(active, frame)) {
        $_7mppn3102jm0og3xc.blur(active);
      }
    });
    cWin.focus();
    $_7mppn3102jm0og3xc.focus(Element$$1.fromDom(cWin.document.body));
    $_3btyzc176jm0og5iv.refresh(cWin);
  };
  var $_4j05j0175jm0og5io = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_4j05j0175jm0og5io.resume(cWin, frame);
    };
    var toReading = function () {
      $_x602b174jm0og5if.input(outerBody, $_7mppn3102jm0og3xc.blur);
    };
    var captureInput = $_6rgkdf15djm0og539.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_b2jnxtyljm0og3oj.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_gg73a116jm0og44b.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_6rgkdf15djm0og539.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_6hgie2yujm0og3pc.eq(editorApi.html(), touchEvent.target()) || $_6hgie2yujm0og3pc.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_6rgkdf15djm0og539.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_6rgkdf15djm0og539.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_6rgkdf15djm0og539.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_6rgkdf15djm0og539.bind(toolstrip, 'touchmove', function () {
  ...
  var $_45usa1177jm0og5iy = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_8zzwgvzvjm0og3wl.add(container, $_ajqgnq10ujm0og42c.resolve('unfocused-selections'));
    $_7p4pskynjm0og3on.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_6rgkdf15djm0og539.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_4j05j0175jm0og5io.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_bc1ia014njm0og4wx.add(span, [
        $_ajqgnq10ujm0og42c.resolve('layer-editor'),
        $_ajqgnq10ujm0og42c.resolve('unfocused-selection')
      ]);
      $_a9fc7d117jm0og44d.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_4ijcf115ojm0og55n.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_65q9xbz1jm0og3qb.append(container, spans);
    };
    var clear = function () {
      $_5sc6ouz0jm0og3q6.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_5sc6ouz0jm0og3q6.remove(container);
    };
    var isActive = function () {
      return $_8q7k44yojm0og3oq.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_915wpv17hjm0og5m2 = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_915wpv17hjm0og5m2.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_axl7fg15cjm0og52z.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_8q7k44yojm0og3oq.owner(socket).dom().defaultView;
    var viewportHeight = $_gg73a116jm0og44b.get(socket) + $_gg73a116jm0og44b.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_gg73a116jm0og44b.get(socket) + $_gg73a116jm0og44b.get(dropup) - greenzoneHeight;
    $_a9fc7d117jm0og44d.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_8lnmgw17gjm0og5lq = {
  ...
  var yFixedData = 'data-' + $_ajqgnq10ujm0og42c.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_ajqgnq10ujm0og42c.resolve('y-property');
  var yScrollingData = 'data-' + $_ajqgnq10ujm0og42c.resolve('scrolling');
  var windowSizeData = 'data-' + $_ajqgnq10ujm0og42c.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_153ir215njm0og55l.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_4usw6ozxjm0og3wq.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_153ir215njm0og55l.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_4usw6ozxjm0og3wq.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_81v3cq11ajm0og44y.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_4usw6ozxjm0og3wq.get(toolbar, 'style');
    $_a9fc7d117jm0og44d.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_4usw6ozxjm0og3wq.set(toolbar, yFixedData, '0px');
    $_4usw6ozxjm0og3wq.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_4usw6ozxjm0og3wq.set(toolbar, 'style', oldToolbarStyle || '');
      $_4usw6ozxjm0og3wq.remove(toolbar, yFixedData);
      $_4usw6ozxjm0og3wq.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_4usw6ozxjm0og3wq.get(viewport, 'style');
    $_3k7nkg15ajm0og52n.register(viewport);
    $_a9fc7d117jm0og44d.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_4usw6ozxjm0og3wq.set(viewport, yFixedData, toolbarHeight + 'px');
    $_4usw6ozxjm0og3wq.set(viewport, yScrollingData, 'true');
    $_4usw6ozxjm0og3wq.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_3k7nkg15ajm0og52n.deregister(viewport);
      $_4usw6ozxjm0og3wq.set(viewport, 'style', oldViewportStyle || '');
      $_4usw6ozxjm0og3wq.remove(viewport, yFixedData);
      $_4usw6ozxjm0og3wq.remove(viewport, yScrollingData);
      $_4usw6ozxjm0og3wq.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_4usw6ozxjm0og3wq.get(dropup, 'style');
    $_a9fc7d117jm0og44d.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_4usw6ozxjm0og3wq.set(dropup, yFixedData, '0px');
    $_4usw6ozxjm0og3wq.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_4usw6ozxjm0og3wq.set(dropup, 'style', oldDropupStyle || '');
      $_4usw6ozxjm0og3wq.remove(dropup, yFixedData);
      $_4usw6ozxjm0og3wq.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_8q7k44yojm0og3oq.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_4usw6ozxjm0og3wq.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_8q7k44yojm0og3oq.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_gg73a116jm0og44b.get(toolbar);
    var dropupHeight = $_gg73a116jm0og44b.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_gg73a116jm0og44b.get(toolbar);
        var dropupHeight_1 = $_gg73a116jm0og44b.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_4usw6ozxjm0og3wq.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_a9fc7d117jm0og44d.set(viewport, 'height', newHeight + 'px');
        $_a9fc7d117jm0og44d.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_8lnmgw17gjm0og5lq.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_4usw6ozxjm0og3wq.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_8lnmgw17gjm0og5lq.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_dbu25017fjm0og5l5 = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_8ot7dz17ejm0og5l1.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_ajqgnq10ujm0og42c.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_a9fc7d117jm0og44d.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_a9fc7d117jm0og44d.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_a9fc7d117jm0og44d.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_4usw6ozxjm0og3wq.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_153ir215njm0og55l.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_4usw6ozxjm0og3wq.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_4usw6ozxjm0og3wq.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_a9fc7d117jm0og44d.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_dbu25017fjm0og5l5.getYFixedData(element) + 'px';
    $_a9fc7d117jm0og44d.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_8q7k44yojm0og3oq.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_8lnmgw17gjm0og5lq.getGreenzone(socket, dropup);
    var refreshCursor = curry($_3btyzc176jm0og5iv.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_9rjro817ajm0og5kk.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_9rjro817ajm0og5kk.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_1mynow17jjm0og5mb = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_a9fc7d117jm0og44d.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_a9fc7d117jm0og44d.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_9rjro817ajm0og5kk.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_8k0t3j17kjm0og5mf.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_6rgkdf15djm0og539.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_8k0t3j17kjm0og5mf.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_dbu25017fjm0og5l5.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_g8rdm6yjjm0og3o4.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_axl7fg15cjm0og52z.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_1mynow17jjm0og5mb.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_a9fc7d117jm0og44d.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_9rjro817ajm0og5kk.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_x602b174jm0og5if.input($_g8rdm6yjjm0og3o4.body(), $_7mppn3102jm0og3xc.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_1z1fxt178jm0og5jc = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_5wkdr9168jm0og58x.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_a9fc7d117jm0og44d.getRaw(platform.socket, 'height'),
          iframeHeight: $_a9fc7d117jm0og44d.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_1zm8tn16jjm0og5c6.exclusive(doc, '.' + $_3k7nkg15ajm0og52n.scrollable()) });
        $_8zzwgvzvjm0og3wl.add(platform.container, $_ajqgnq10ujm0og42c.resolve('fullscreen-maximized'));
        $_3umfqf169jm0og59a.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_a9fc7d117jm0og44d.set(platform.socket, 'overflow', 'scroll');
        $_a9fc7d117jm0og44d.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_7mppn3102jm0og3xc.focus(editorApi.body());
        ...
        iosApi.set($_1z1fxt178jm0og5jc.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_57fyzr173jm0og5i5.stubborn,
        ...
        iosEvents.set($_45usa1177jm0og5iy.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_a9fc7d117jm0og44d.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_a9fc7d117jm0og44d.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_8zzwgvzvjm0og3wl.remove(platform.container, $_ajqgnq10ujm0og42c.resolve('fullscreen-maximized'));
      $_3umfqf169jm0og59a.restoreStyles();
      $_3k7nkg15ajm0og52n.deregister(platform.toolbar);
      $_a9fc7d117jm0og44d.remove(platform.socket, 'overflow');
      $_a9fc7d117jm0og44d.remove(platform.socket, '-webkit-overflow-scrolling');
      $_7mppn3102jm0og3xc.blur(platform.editor.getFrame());
      $_5wkdr9168jm0og58x.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_1hb3by172jm0og5hm = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_a9fc7d117jm0og44d.set(mobile.toolstrip, 'width', '100%');
    $_a9fc7d117jm0og44d.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_c8hipz16bjm0og59z.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_1hb3by172jm0og5hm.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_3bnp5m171jm0og5he = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_ajqgnq10ujm0og42c.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_bp6e7b16kjm0og5cf.makeEditSwitch(webapp);
    var socket = $_bp6e7b16kjm0og5cf.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_3bnp5m171jm0og5he.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_cx0b5c17njm0og5mx = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_8q8ecd10ajm0og3yg.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_g6pg5317qjm0og5nb = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_cx0b5c17njm0og5mx.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_g6pg5317qjm0og5nb.fireSkinLoaded(editor));
      } else {
        $_g6pg5317qjm0og5nb.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_6rwovay4jm0og3m3.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_7p4pskynjm0og3on.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_7mppn3102jm0og3xc.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_axl7fg15cjm0og52z.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_8q8ecd10ajm0og3yg.orientationChanged()], { width: $_axl7fg15cjm0og52z.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_ajqgnq10ujm0og42c.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_b2jnxtyljm0og3oj.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_b2jnxtyljm0og3oj.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_3plipl108jm0og3yc.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_ajqgnq10ujm0og42c.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_ajqgnq10ujm0og42c.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_8q8ecd10ajm0og3yg.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_1lqpb110vjm0og42f.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_1lqpb110vjm0og42f.forToolbar('readonly-back', function () {
        ...
        var features = $_80zo9g10bjm0og3yk.setup(realm, editor);
        var items = $_80zo9g10bjm0og3yk.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_62gz6n17pjm0og5n2.init(realm, editor);
      });
      return {
